...
int main()
{
    ...
    do
    {
        std::cout << "\nMenue:" << std::endl
                  ...
                  << "(3): Datenelement hinten entfernen" << std::endl
				  << "(4): Element loeschen" << std::endl
                  << "(5): Datenbank vorwaerts ausgeben" << std::endl
				  << "(6): Datenbank rueckwaerts ausgeben" << std::endl
                  << "(0): Beenden" << std::endl;
        std::cin >> abfrage;
        std::cin.ignore(10, '\n');
        ...
        switch (abfrage)
        {
			...
			case '4':
				...
				{
					int matrikelNr;
					std::cout << std::endl << "Matrikel Nummer: ";
					std::cin >> matrikelNr;
					studentenListe.deleteElement(matrikelNr);
				}
				else
				{
					std::cout << "Die Liste ist leer!\n\n";
